 ...
 *
 */
package net.mcreator.hypixelsb;
...
@Mod("hypixelsb")
public class HypixelsbMod {
	public static final Logger LOGGER = LogManager.getLogger(HypixelsbMod.class);
	public static final String MODID = "hypixelsb";
	...
	public HypixelsbMod() {
		...
		HypixelsbModBlocks.REGISTRY.register(bus);
		HypixelsbModItems.REGISTRY.register(bus);
