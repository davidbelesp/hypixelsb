...
package net.mcreator.hypixelsb.entity;
...
public class WitherLordEntity extends Monster {
	...
	public WitherLordEntity(EntityType<WitherLordEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(HypixelsbModEntities.WITHER_LORD.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
